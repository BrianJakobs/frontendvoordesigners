...
var checkStatus = setInterval(function () {
    ...
    if (request.status == 200) {
        ...
        document.querySelector(".loadingContainer").classList.add("fade");
        setTimeout(function () {
            document.querySelector(".loadingContainer").classList.add("hide");
        }, 3000);
    } else {
        console.log("bezig met laden...");
    }
}, 100);
...
function writeHTML(jsonObj) {
    var allMovies = jsonObj,
        ...
        themeToggle = document.createElement("article");
    ...
    for (var m = 0; m < allImages.length; m++) {
        if (allImages[m].getAttribute('src') == "") {
            console.log("empty");
            allImages[m].src = "assets/images/profileError.svg";
        } else if (allImages[m].onerror) {
            console.log("empty");
            allImages[m].src = "assets/images/profileError.svg";
        } else {
    ...
    document.querySelector("nav .toggleBtn").addEventListener("click", function () {
        document.querySelector("nav .toggleCirkle").classList.toggle("toggleActive");
        document.querySelector("body").classList.toggle("colourBlue");
        document.querySelector("body").classList.toggle("textColourLightGrey");
        document.querySelector("h1").classList.toggle("TextColourPink");

        var allH2 = document.querySelectorAll("h2");

        for (var h = 0; h < allH2.length; h++) {
            allH2[h].classList.toggle("TextColourPink");
        };

        document.querySelector("nav").classList.toggle("colourBlue");
        document.querySelector(".metaData").classList.toggle("textColourDarkGrey");

        var allmoreButton = document.querySelectorAll("div.container article > div:last-of-type");

        for (var o = 0; o < allmoreButton.length; o++) {
            allmoreButton[o].classList.toggle("colourPink");
        };

        var allmoreButtonP = document.querySelectorAll(".container article > div:last-of-type p");

        for (var p = 0; p < allmoreButtonP.length; p++) {
            allmoreButtonP[p].classList.toggle("textColourBlue");
        };

        document.querySelector("div.progress-indicator li").classList.toggle("progressBorder");
        document.querySelector("footer div.progress-indicator li.progress-active").classList.toggle("progressBorder");
        document.querySelector("nav .toggleBtn").classList.toggle("colourBlue");
        document.querySelector("nav .toggleBtn").classList.toggle("toggleBorder");
        document.querySelector("nav .toggleCirkle").classList.toggle("colourPink");

        if (document.querySelector("nav .toggleCirkle").classList.contains("toggleActive") === true) {
            document.querySelector("nav img").src = "assets/images/searchIcon_darkTheme.svg";
            document.querySelector("nav img").src = "assets/images/searchIcon_darkTheme.svg";
            document.querySelector("main section .pijlen:nth-of-type(1) img").src = "assets/images/leftArrow_darkTheme.svg";
            document.querySelector("main section .pijlen:nth-of-type(2) img").src = "assets/images/rightArrow_darkTheme.svg";

            var allmoreButtonArrow = document.querySelectorAll("article > div:last-of-type img");

            for (var a = 0; a < allmoreButtonArrow.length; a++) {
                allmoreButtonArrow[a].src = "assets/images/arrowDown_darkTheme.svg";
            };
        } else if (document.querySelector("nav .toggleCirkle").classList.contains("toggleActive") === false) {
            document.querySelector("nav img").src = "assets/images/searchIcon.svg";
            document.querySelector("nav img").src = "assets/images/searchIcon.svg";
            document.querySelector("main section .pijlen:nth-of-type(1) img").src = "assets/images/leftArrow.svg";
            document.querySelector("main section .pijlen:nth-of-type(2) img").src = "assets/images/rightArrow.svg";

            var allmoreButtonArrow = document.querySelectorAll("article > div:last-of-type img");

            for (var a = 0; a < allmoreButtonArrow.length; a++) {
                allmoreButtonArrow[a].src = "assets/images/arrowDown.svg";
            };
        }
    });
    ...
    var buttons = document.querySelectorAll(".container article > div:last-of-type");
    ...
    for (var b = 0; b < buttons.length; b++) {
        buttons[b].addEventListener("click", function () {
            ...
            var buttonImages = document.querySelectorAll("main section .container article > div:last-of-type img");
            for (var m = 0; m < buttonImages.length; m++) {
                buttonImages[m].classList.toggle("imgRotate");
            }
        });
    }

    movie1Button.addEventListener("click", function () {
        if (!moreInfo1.classList.contains("block")) {
            moreInfo1.classList.toggle("block");
            setTimeout(function () {
    ...
    movie2Button.addEventListener("click", function () {
        if (!moreInfo2.classList.contains("block")) {
            moreInfo2.classList.toggle("block");
            setTimeout(function () {
    ...
    movie3Button.addEventListener("click", function () {
        if (!moreInfo3.classList.contains("block")) {
            moreInfo3.classList.toggle("block");
            setTimeout(function () {
    ...
    movie4Button.addEventListener("click", function () {
        if (!moreInfo4.classList.contains("block")) {
            moreInfo4.classList.toggle("block");
            setTimeout(function () {
    ...
    movie5Button.addEventListener("click", function () {
        if (!moreInfo5.classList.contains("block")) {
            moreInfo5.classList.toggle("block");
            setTimeout(function () {
    ...
    movie6Button.addEventListener("click", function () {
        if (!moreInfo6.classList.contains("block")) {
            moreInfo6.classList.toggle("block");
            setTimeout(function () {
